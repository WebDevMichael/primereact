...
export class TreeTableHeader extends Component {
  ...
  renderResizer(column) {
    if (this.props.resizableColumns) {
      return <span className="p-column-resizer p-clickable" onMouseDown={(e) => this.onResizerMouseDown(e, column)} />;
    } else {
      return null;
    }
  }
    ...
    if (column.props.filter && options.renderFilter) {
      filterElement = column.props.filterElement || (
        <InputText
          ...
          defaultValue={
            this.props.filters && this.props.filters[column.props.field]
              ? this.props.filters[column.props.field].value
              : null
          }
    ...
    if (options.filterOnly) {
      ...
      return (
        <th
          ...
          onMouseDown={(e) => this.onHeaderMouseDown(e, column)}
          onKeyDown={(e) => this.onHeaderKeyDown(e, column)}
          rowSpan={column.props.rowSpan}
          colSpan={column.props.colSpan}
          aria-sort={ariaSortData}
          onDragStart={(e) => this.onDragStart(e, column)}
          onDragOver={(e) => this.onDragOver(e, column)}
          onDragLeave={(e) => this.onDragLeave(e, column)}
